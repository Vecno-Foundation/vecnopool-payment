...
export const sompiToVecnoStringWithSuffix: (a: number, b: number, c: number) => void;
export const sompiToVecnoString: (a: number, b: number) => void;
export const vecnoToSompi: (a: number, b: number) => number;
