...
export const vecnoToVeni: (a: number, b: number) => number;
export const veniToVecnoString: (a: number, b: number) => void;
export const veniToVecnoStringWithSuffix: (a: number, b: number, c: number) => void;
